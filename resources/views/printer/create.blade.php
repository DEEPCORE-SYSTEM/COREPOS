                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" required placeholder="@lang('lang_v1.printer_name_help')">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="char_per_line" id="char_per_line" value="42" class="form-control" required placeholder="@lang('lang_v1.char_per_line_help')">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="ip_address_div">
                        <div class="form-group">
                            ...
                            <input type="text" name="ip_address" id="ip_address" class="form-control" required placeholder="@lang('lang_v1.ip_address_help')">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="port_div">
                        <div class="form-group">
                            ...
                            <input type="text" name="port" id="port" value="9100" class="form-control" required>
