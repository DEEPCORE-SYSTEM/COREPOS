    ...
    <form action="{{ action('PurchaseController@store') }}" method="post" id="add_purchase_form"
            ...
            <div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control select2" required>
                        ...
                        <option value="{{ $key }}" {{ $key == $default_purchase_status ? 'selected' : '' }}>{{ $value }}
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <select name="location_id" id="location_id" class="form-control select2" required
                        @if(!empty($bl_attributes)) @foreach($bl_attributes as $key=> $value)
                        {{ $key }}="{{ is_array($value) ? implode(' ', $value) : ($value ?? '') }}"
                        @endforeach
                        @endif>
                        <option value="">{{ __('messages.please_select') }}</option>
                        @foreach($business_locations as $id => $name)
                        <option value="{{ $id }}" {{ $id == $default_location ? 'selected' : '' }}>{{ $name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="custom_field_1" id="custom_field_1" class="form-control"
                        placeholder="{{ $custom_field_1_label }}" {{ $is_custom_field_1_required ? 'required' : '' }}>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="custom_field_2" id="custom_field_2" class="form-control"
                        placeholder="{{ $custom_field_2_label }}" {{ $is_custom_field_2_required ? 'required' : '' }}>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="custom_field_3" id="custom_field_3" class="form-control"
                        placeholder="{{ $custom_field_3_label }}" {{ $is_custom_field_3_required ? 'required' : '' }}>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="custom_field_4" id="custom_field_4" class="form-control"
                        placeholder="{{ $custom_field_4_label }}" {{ $is_custom_field_4_required ? 'required' : '' }}>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <select name="purchase_order_ids[]" id="purchase_order_ids" class="form-control select2" multiple>
                    </select>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_details" id="shipping_details" class="form-control"
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    <label for="shipping_charges">(+) {{ __('purchase.additional_shipping_charges') }}:</label>
                    <input type="text" name="shipping_charges" id="shipping_charges" class="form-control input_number"
                        value="{{ old('shipping_charges', 0) }}" required>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_custom_field_1" id="shipping_custom_field_1" class="form-control"
                        placeholder="{{ $shipping_custom_label_1 }}" value="{{ old('shipping_custom_field_1') ?? '' }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_custom_field_2" id="shipping_custom_field_2" class="form-control"
                        placeholder="{{ $shipping_custom_label_2 }}" value="{{ old('shipping_custom_field_2') ?? '' }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_custom_field_3" id="shipping_custom_field_3" class="form-control"
                        placeholder="{{ $shipping_custom_label_3 }}" value="{{ old('shipping_custom_field_3') ?? '' }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_custom_field_4" id="shipping_custom_field_4" class="form-control"
                        placeholder="{{ $shipping_custom_label_4 }}" value="{{ old('shipping_custom_field_4') ?? '' }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_custom_field_5" id="shipping_custom_field_5" class="form-control"
                        placeholder="{{ $shipping_custom_label_5 }}" value="{{ old('shipping_custom_field_5') ?? '' }}"
            ...
            <div class="col-md-8 col-md-offset-4" id="additional_expenses_div" style="display: none;">
                <table class="table table-condensed">
                    ...
                    <tbody>
                        @for ($i = 1; $i <= 4; $i++) <tr>
                            <td>
                                <input type="text" name="additional_expense_key_{{ $i }}" class="form-control"
                                    id="additional_expense_key_{{ $i }}"
                                    value="{{ old('additional_expense_key_' . $i) ?? '' }}">
                            </td>
                            <td>
                                <input type="text" name="additional_expense_value_{{ $i }}"
                                    class="form-control input_number" id="additional_expense_value_{{ $i }}"
                                    value="{{ old('additional_expense_value_' . $i, 0) }}">
                            </td>
                            </tr>
                            @endfor
                    </tbody>
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <input type="hidden" name="final_total" id="grand_total_hidden" value="{{ old('final_total', 0) }}">
