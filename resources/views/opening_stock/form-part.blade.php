                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden"
                                            name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][purchase_line_id]"
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text"
                                                name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][quantity]"
                                    ...
                                    <td>
                                        <input type="text"
                                            name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][purchase_price]"
                                            value="{{ @num_format($purcahse_price) }}"
                                    ...
                                    <td>
                                        <input type="text"
                                            name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][exp_date]"
                                            value="{{ !empty($var['exp_date']) ? @format_date($var['exp_date']) : '' }}"
                                    ...
                                    <td>
                                        <input type="text"
                                            name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][lot_number]"
                                            value="{{ $lot_number }}" class="form-control input-sm">
                                    </td>
                                    @endif
