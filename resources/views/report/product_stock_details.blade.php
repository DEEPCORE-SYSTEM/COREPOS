        ...
        <div class="col-md-12">
            <div class="box box-primary" id="accordion">
                ...
                <div id="collapseFilter" class="panel-collapse active collapse in" aria-expanded="true">
                    <div class="box-body">
                        <div class="row">
                            <form action="{{ action('ReportController@productStockDetails') }}" method="get">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="variation_id" id="variation_id" class="form-control" placeholder="{{ __('lang_v1.search_product_placeholder') }}">
                                                <!-- Opciones dinámicas pueden ir aquí -->
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <button type="submit" class="btn btn-primary">{{ __('lang_v1.search') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
