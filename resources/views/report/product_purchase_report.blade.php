...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ action('ReportController@getStockReport') }}" method="get" id="product_purchase_report_form">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="date_range" id="product_pr_date_filter" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                    </div>
                </div>
            </form>
