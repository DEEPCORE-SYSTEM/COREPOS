...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ action('ReportController@getStockReport') }}" method="get" id="sales_representative_filter_form">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="sr_id">{{ __('report.user') }}:</label>
                        <select name="sr_id" id="sr_id" class="form-control select2" style="width:100%" placeholder="{{ __('report.all_users') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="sr_business_id" id="sr_business_id" class="form-control select2" style="width:100%">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="date_range" id="sr_date_filter" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                    </div>
                </div>
            </form>
