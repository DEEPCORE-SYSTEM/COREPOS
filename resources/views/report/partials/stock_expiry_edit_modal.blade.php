        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="exp_date" value="{{ \Carbon\Carbon::parse($purchase_line->exp_date)->format('Y-m-d') }}" class="form-control" required id="exp_date_expiry_modal" readonly>
              <i>
