...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ action('ReportController@getCustomerGroup') }}" method="get" id="cg_report_filter_form">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="cg_customer_group_id">{{ __('lang_v1.customer_group_name') }}:</label>
                        <select name="cg_customer_group_id" id="cg_customer_group_id" class="form-control select2" style="width:100%">
                            @foreach($customer_group as $id => $name)
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="cg_location_id" id="cg_location_id" class="form-control select2" style="width:100%">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="date_range" id="cg_date_range" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                    </div>
                </div>
            </form>
