        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="service_staff_id" id="service_staff_id" class="form-control select2" style="width:100%" placeholder="{{ __('lang_v1.all') }}">
                        ...
                        <option value="{{ $key }}">{{ $waiter }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="date_range" id="ssr_date_range" class="form-control" value="{{ format_date('first day of this month') }} ~ {{ format_date('last day of this month') }}" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                </div>
            </div>
