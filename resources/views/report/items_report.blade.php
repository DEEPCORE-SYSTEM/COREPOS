        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="ir_purchase_date_filter" id="ir_purchase_date_filter"
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="ir_sale_date_filter" id="ir_sale_date_filter"
                        class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="only_mfg" id="only_mfg_products" value="1">
