                    ...
                    <div class="box-body">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="tr_location_id">{{ __('purchase.business_location') }}:</label>
                                <select name="tr_location_id" class="form-control select2" style="width:100%">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="tr_date_range">{{ __('report.date_range') }}:</label>
                                <input type="text" name="date_range" value="{{ \Carbon\Carbon::parse('first day of this month')->format('Y-m-d') . ' ~ ' . \Carbon\Carbon::parse('last day of this month')->format('Y-m-d') }}"
                                    placeholder="{{ __('lang_v1.select_a_date_range') }}" class="form-control" id="tr_date_range" readonly>
                            </div>
                        </div>
