...
<section class="content no-print">
	<form action="{{ action('CombinedPurchaseReturnController@update') }}" method="POST"
		id="purchase_return_form" enctype="multipart/form-data">
		@csrf
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input type="text" name="ref_no" id="ref_no" class="form-control" value="{{ $purchase_return->ref_no }}">
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="transaction_date" id="transaction_date"
									class="form-control" value="{{ @format_datetime($purchase_return->transaction_date) }}" readonly required>
							</div>
						</div>
					</div>
