...
<section class="content">
	<form action="{{ action('PurchaseReturnController@store') }}" method="POST" id="purchase_return_form">
		@csrf
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<input type="text" name="ref_no" id="ref_no" class="form-control"
						value="{{ !empty($purchase->return_parent->ref_no) ? $purchase->return_parent->ref_no : '' }}">
				</div>
