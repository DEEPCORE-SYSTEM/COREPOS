...
<section class="content no-print">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" name="purchase_list_filter_date_range" id="purchase_list_filter_date_range" placeholder="{{ __('lang_v1.select_a_date_range') }}" class="form-control" readonly />
        </div>
    </div>
