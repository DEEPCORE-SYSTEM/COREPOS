<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <form action="{{ action('TransactionPaymentController@update', [$payment_line->id]) }}" method="POST" id="transaction_payment_add_form" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <input type="hidden" id="default_payment_accounts" name="default_payment_accounts" value="{{ !empty($transaction->location) ? $transaction->location->default_payment_accounts : '[]' }}">
      ...
      <div class="modal-body">
        ...
        <div class="row payment_row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" name="paid_on" id="paid_on" class="form-control" readonly required value="{{ format_datetime($payment_line->paid_on) }}">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label for="note">@lang('lang_v1.payment_note'):</label>
