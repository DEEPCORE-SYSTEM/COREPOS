<div class="modal-dialog" role="document">
    <div class="modal-content">
        <form action="{{ action('TransactionPaymentController@postPayContactDue') }}" method="POST"
            id="pay_contact_due_form" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="well">
                            ...
                            @if(!empty($contact_details->opening_balance) || $contact_details->opening_balance !=
                            '0.00')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="amount" value="{{ num_format($payment_line->amount) }}"
                                    class="form-control input_number" required placeholder="{{ __('sale.amount') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="paid_on" value="{{ format_datetime($payment_line->paid_on) }}"
