...
<div class="payment_details_div {{ $payment_line->method !== 'custom_pay_1' ? 'hide' : '' }}" data-type="custom_pay_1">
    <div class="col-md-12">
        <div class="form-group">
            <label for="transaction_no_1">{{ __('lang_v1.transaction_no') }}</label>
            <input type="text" name="transaction_no_1" class="form-control" 
...
<div class="payment_details_div {{ $payment_line->method !== 'custom_pay_2' ? 'hide' : '' }}" data-type="custom_pay_2">
    <div class="col-md-12">
        <div class="form-group">
            <label for="transaction_no_2">{{ __('lang_v1.transaction_no') }}</label>
            <input type="text" name="transaction_no_2" class="form-control" 
                placeholder="{{ __('lang_v1.transaction_no') }}" 
                value="{{ $payment_line->transaction_no }}">
        </div>
    </div>
...
<div class="payment_details_div {{ $payment_line->method !== 'custom_pay_3' ? 'hide' : '' }}" data-type="custom_pay_3">
    <div class="col-md-12">
        <div class="form-group">
            <label for="transaction_no_3">{{ __('lang_v1.transaction_no') }}</label>
            <input type="text" name="transaction_no_3" class="form-control" 
                placeholder="{{ __('lang_v1.transaction_no') }}" 
                value="{{ $payment_line->transaction_no }}">
        </div>
    </div>
