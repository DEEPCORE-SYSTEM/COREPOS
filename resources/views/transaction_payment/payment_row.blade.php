<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form action="{{ action('TransactionPaymentController@store') }}" method="POST"
            id="transaction_payment_add_form" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="transaction_id" value="{{ $transaction->id }}">

            @if(!empty($transaction->location))
            <input type="hidden" name="default_payment_accounts" id="default_payment_accounts"
                value="{{ $transaction->location->default_payment_accounts }}">
            @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="well">
                            ...
                            </strong>{{ $transaction->contact->supplier_business_name }}
                            @endif
                        </div>
                    </div>
                    @endif
