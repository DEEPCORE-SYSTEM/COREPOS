        ...
        <div class="row">
            <div class="@if (!empty($pos_settings['hide_product_suggestion']) && !empty($pos_settings['hide_recent_trans'])) col-md-10 col-md-offset-1 @else col-md-7 @endif col-sm-12">
                <div class="box box-success">
                    ...
                    <form action="{{ action('SellPosController@update', [$transaction->id]) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="transaction_date" id="transaction_date"
                                                    value="{{ format_datetime($transaction->transaction_date) }}"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="price_group_text"
                                                    value="{{ $transaction->price_group->name }}" class="form-control"
                                                    readonly>
                                                <span class="input-group-addon">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="types_of_service_text"
                                                    value="{{ $transaction->types_of_service->name }}" class="form-control"
                                                    readonly>

                                                <input type="hidden" name="types_of_service_id" id="types_of_service_id"
                                                    value="{{ $transaction->types_of_service_id }}">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="contact_id" id="customer_id" class="form-control mousetrap"
                                                ...
                                                <option value="" disabled selected>Enter Customer name / phone
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select name="commission_agent" class="form-control select2">
                                                <option value="" selected>{{ __('lang_v1.commission_agent') }}
                                                </option>
                                                @foreach ($commission_agent as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ $transaction->commission_agent == $id ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
