...
<section class="content no-print">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="sell_list_filter_location_id" id="sell_list_filter_location_id" class="form-control select2" style="width:100%" placeholder="{{ __('lang_v1.all') }}">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="sell_list_filter_customer_id" id="sell_list_filter_customer_id" class="form-control select2" style="width:100%" placeholder="{{ __('lang_v1.all') }}">
                <option value="">{{ __('lang_v1.all') }}</option>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" name="sell_list_filter_date_range" id="sell_list_filter_date_range" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
        </div>
    </div>
