                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="shipping_details_modal" name="shipping_details_modal" class="form-control"
                                placeholder="{{ __('sale.shipping_details') }}" required rows="4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="shipping_address_modal" name="shipping_address_modal" class="form-control"
                                placeholder="{{ __('lang_v1.shipping_address') }}" rows="4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="shipping_charges_modal" name="shipping_charges_modal"
                                    class="form-control input_number" placeholder="{{ __('sale.shipping_charges') }}"
                                    value="{{ !empty($transaction->shipping_charges) ? number_format($transaction->shipping_charges, 2) : 0 }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="shipping_status_modal" name="shipping_status_modal" class="form-control">
                                <option value="">{{ __('messages.please_select') }}</option>
                                @foreach ($shipping_statuses as $key => $status)
                                <option value="{{ $key }}"
                                    {{ (!empty($transaction->shipping_status) && $transaction->shipping_status == $key) ? 'selected' : '' }}>
                                    {{ $status }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="delivered_to_modal" name="delivered_to_modal" class="form-control"
                                placeholder="{{ __('lang_v1.delivered_to') }}"
                                value="{{ !empty($transaction->delivered_to) ? $transaction->delivered_to : '' }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="shipping_custom_field_1" name="shipping_custom_field_1"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="shipping_custom_field_2" name="shipping_custom_field_2"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="shipping_custom_field_3" name="shipping_custom_field_3"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="shipping_custom_field_4" name="shipping_custom_field_4"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="shipping_custom_field_5" name="shipping_custom_field_5"
