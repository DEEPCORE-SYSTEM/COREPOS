    ...
    <div class="row">
        <div
            ...
            <form action="{{ action('SellPosController@store') }}" method="POST" id="add_pos_sell_form">
                ...
                <input type="hidden" name="location_id" value="{{ $default_location->id }}" id="location_id"
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select name="price_group" id="price_group" class="form-control select2"
                                        ...
                                        <option value="{{ $key }}"
                                            {{ $key == $selected_price_group ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                        @endforeach
                                    </select>
