<div class="modal-dialog" role="document">
    <form action="{{ action('PurchaseOrderController@postEditPurchaseOrderStatus', ['id' => $id]) }}" method="POST" id="update_po_status_form">
        @method('PUT')
        @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="po_status">{{ __('sale.status') }}:</label>
