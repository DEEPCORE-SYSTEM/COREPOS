    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tbody>
                <tr>
                    <td>
                        <input type="text" name="product_variation[{{ $row_index }}][variations][0][sub_sku]"
                            class="form-control input-sm">
                    </td>
                    <td>
                        <input type="text" name="product_variation[{{ $row_index }}][variations][0][value]"
                    ...
                    <td class="{{ $class }}">
                        <div class="input-group">
                            <input type="text" name="product_variation[{{ $row_index }}][variations][0][profit_percent]"
                    ...
                    <td class="{{ $class }}">
                        <input type="text" name="product_variation[{{ $row_index }}][variations][0][default_sell_price]"
                            value="{{ $default }}" class="form-control input-sm variable_dsp input_number"
                            placeholder="{{ __('product.exc_of_tax') }}" required>

                        <input type="text" name="product_variation[{{ $row_index }}][variations][0][sell_price_inc_tax]"
                            value="{{ $default }}" class="form-control input-sm variable_dsp_inc_tax input_number"
                            placeholder="{{ __('product.inc_of_tax') }}" required>
                    </td>
                    <td>
                        <input type="file" name="variation_images_{{ $row_index }}_0[]" class="variation_images"
