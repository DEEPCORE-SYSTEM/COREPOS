            ...
            <tr>
                <td>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="single_dpp"
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="single_dpp_inc_tax" value="{{ @num_format($variation->dpp_inc_tax) }}"
