<div class="modal-dialog modal-lg" role="document">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $product_name) }}"
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="barcode_type" id="barcode_type" class="form-control select2" required>
                                ...
                                <option value="{{ $key }}" {{ $key == 'C128' ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="unit_id" id="unit_id" class="form-control select2" required>
                                ...
                                <option value="{{ $key }}" {{ old('unit_id') == $key ? 'selected' : '' }}>{{ $value }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="brand_id" id="brand_id" class="form-control select2">
                                ...
                                <option value="{{ $key }}" {{ old('brand_id') == $key ? 'selected' : '' }}>{{ $value }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4" id="alert_quantity_div">
                        <div class="form-group">
                            ...
                            <input type="text" name="alert_quantity" id="alert_quantity"
                                class="form-control input_number" placeholder="{{ __('product.alert_quantity') }}"
                                min="0" value="{{ old('alert_quantity') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="warranty_id" id="warranty_id" class="form-control select2">
                                ...
                                <option value="{{ $key }}" {{ old('warranty_id') == $key ? 'selected' : '' }}>
                                    {{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="multi-input">
                                ...
                                <input type="text" name="expiry_period" id="expiry_period"
                                    value="{{ old('expiry_period', $expiry_period) }}"
                                ...
                                <select name="expiry_period_type" id="expiry_period_type"
                                    ...
                                    <option value="months"
                                        {{ old('expiry_period_type', 'months') == 'months' ? 'selected' : '' }}>
                                        {{ __('product.months') }}
                                    </option>
                                    <option value="days" {{ old('expiry_period_type') == 'days' ? 'selected' : '' }}>
                                        {{ __('product.days') }}
                                    </option>
    ...
    @foreach($business_locations as $key => $location)
        <option value="{{ $key }}"
            {{ in_array($key, is_array($default_location) ? $default_location : (!is_null($default_location) ? (array) $default_location : [])) ? 'selected' : '' }}>
            {{ $location }}
        </option>
    @endforeach
</select>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="weight" id="weight" class="form-control"
                                placeholder="{{ __('lang_v1.weight') }}" value="{{ old('weight') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="tax" id="tax" class="form-control select2">
                                ...
                                <option value="{{ $key }}" {{ old('tax') == $key ? 'selected' : '' }}>
                                    {{ $tax }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tax_type" id="tax_type" class="form-control select2" required>
                                <option value="inclusive"
                                    {{ old('tax_type', 'exclusive') == 'inclusive' ? 'selected' : '' }}>
                                    {{ __('product.inclusive') }}
                                </option>
                                <option value="exclusive"
                                    {{ old('tax_type', 'exclusive') == 'exclusive' ? 'selected' : '' }}>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_custom_field1" id="product_custom_field1"
                                ...
                                value="{{ old('product_custom_field1') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_custom_field2" id="product_custom_field2"
                                ...
                                value="{{ old('product_custom_field2') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_custom_field3" id="product_custom_field3"
                                ...
                                value="{{ old('product_custom_field3') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_custom_field4" id="product_custom_field4"
                                ...
                                value="{{ old('product_custom_field4') }}">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id="submit_quick_product">@lang( 'messages.save'
                    )</button>
