        ...
        <table class="table table-bordered add-product-price-table table-condensed" id="product_variation_form_part">
            ...
            <tbody>
                ...
                <tr class="variation_row">
                    <td>
                        <input type="text" name="product_variation[{{ $loop->index }}][name]"
                            value="{{ $product_variation->name }}" class="form-control input-sm variation_name"
                            required>
                        <input type="hidden" class="row_index" value="{{ $loop->index }}">
                        <input type="hidden" name="product_variation[{{ $loop->index }}][product_variation_id]"
                        ...
                        <table class="table table-condensed table-bordered blue-header variation_value_table">
                            <tr>
                                ...
                                <th><button type="button"
                                        class="btn btn-success btn-xs add_variation_value_row">+</button></th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="drag-select">
                                    <input type="number"
                                        ...
                                        class="form-control input-sm variable_dsp" min="0"
                                    ...
                                    <input type="number"
                                        ...
                                        class="form-control input-sm variable_dsp_inc_tax" min="0"
                                        placeholder="{{ __('product.inc_of_tax') }}">
                                </td>
                                <td>
                                    <button type="button"
                                        class="btn btn-danger btn-xs remove_variation_value_row">-</button>
