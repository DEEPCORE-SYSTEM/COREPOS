            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Formulario para actualizar la configuración de ubicación -->
                                <form action="{{ route('location.settings_update', [$location->id]) }}" method="POST"
                                    id="bl_receipt_setting_form">
                                    @csrf
                                    <!-- Token de seguridad obligatorio en Laravel -->

                                    <!-- Configuración de impresión del recibo en la factura -->
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label
                                                for="print_receipt_on_invoice">{{ __('receipt.print_receipt_on_invoice') }}:</label>
                                            @show_tooltip(__('tooltip.print_receipt_on_invoice'))
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-file-alt"></i>
                                                </span>
                                                <select name="print_receipt_on_invoice" id="print_receipt_on_invoice"
                                                    class="form-control select2" required>
                                                    @foreach($printReceiptOnInvoice as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ $location->print_receipt_on_invoice == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <!-- Tipo de impresora para recibos -->
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label
                                                for="receipt_printer_type">{{ __('receipt.receipt_printer_type') }}:*</label>
                                            @show_tooltip(__('tooltip.receipt_printer_type'))
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-print"></i>
                                                </span>
                                                <select name="receipt_printer_type" id="receipt_printer_type"
                                                    class="form-control select2" required>
                                                    @foreach($receiptPrinterType as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ $location->receipt_printer_type == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <!-- Impresora de recibos seleccionada -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="printer_id" id="printer_id" class="form-control select2"
                                                    ...
                                                    <option value="{{ $key }}"
                                                        {{ $location->printer_id == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <!-- Selección del diseño de factura -->
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="invoice_layout_id" id="invoice_layout_id"
                                                    class="form-control select2" required>
                                                    @foreach($invoice_layouts as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ $location->invoice_layout_id == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="invoice_scheme_id" id="invoice_scheme_id"
                                                    class="form-control select2" required>
                                                    @foreach($invoice_schemes as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ $location->invoice_scheme_id == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
