                ...
                <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="option-div {{ $invoice->scheme_type == 'year' ? 'active' : '' }}">
                                    <h4>FORMAT: <br>{{ date('Y') }}{{ config('constants.invoice_scheme_separator') }}XXXX 
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" required placeholder="@lang('invoice.name')" value="{{ $invoice->name }}">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-12 col-sm-12">
                                    ...
                                    <input type="text" name="prefix" id="prefix" class="form-control" placeholder="" value="{{ $invoice->prefix }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-12 col-sm-12">
                                    ...
                                    <input type="number" name="start_number" id="start_number" class="form-control" required min="0" value="{{ $invoice->start_number }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-md-12 col-sm-12">
                                        ...
                                        <select name="total_digits" id="total_digits" class="form-control" required>
                                            @foreach (range(4, 10) as $digit)
                                                <option value="{{ $digit }}" {{ $invoice->total_digits == $digit ? 'selected' : '' }}>{{ $digit }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
