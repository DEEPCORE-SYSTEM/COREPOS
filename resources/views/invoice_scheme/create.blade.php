<div class="modal-dialog" role="document">
  ...
  <form action="{{ action('InvoiceSchemeController@store') }}" method="POST" id="invoice_scheme_add_form">
    @csrf
                    ...
                    <div class="form-group">
                        <div class="option-div">
                            <h4>FORMAT: <br>{{ date('Y') }}{{ config('constants.invoice_scheme_separator') }}XXXX 
                                <i class="fa fa-check-circle pull-right icon"></i></h4>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-12 col-sm-12">
                            ...
                            <input type="number" name="start_number" id="start_number" class="form-control" required min="0" value="0">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="input-group col-md-12 col-sm-12">
                                ...
                                <select name="total_digits" id="total_digits" class="form-control" required>
                                    @foreach (range(4, 10) as $digit)
                                        <option value="{{ $digit }}" {{ $digit == 4 ? 'selected' : '' }}>{{ $digit }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
