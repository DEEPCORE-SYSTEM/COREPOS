...
<section class="content no-print">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="sell_list_filter_location_id" class="form-control select2" style="width:100%" id="sell_list_filter_location_id">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="sell_list_filter_customer_id" class="form-control select2" style="width:100%" id="sell_list_filter_customer_id">
                <option value="">{{ __('lang_v1.all') }}</option>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="created_by" class="form-control select2" style="width:100%" id="created_by">
                @foreach ($sales_representative as $key => $representative)
                    <option value="{{ $key }}">{{ $representative }}</option>
                @endforeach
            </select>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="sell_list_filter_payment_status" class="form-control select2" style="width:100%" id="sell_list_filter_payment_status">
                <option value="">{{ __('lang_v1.all') }}</option>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="shipping_status" class="form-control select2" style="width:100%" id="shipping_status">
                <option value="">{{ __('lang_v1.all') }}</option>
        ...
        @if(!empty($service_staffs))
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="service_staffs" class="form-control select2" style="width:100%" id="service_staffs">
                        <option value="">{{ __('lang_v1.all') }}</option>
