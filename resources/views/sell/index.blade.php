...
<section class="content no-print">
    ...
    @if(!empty($sources))
    <!-- Filtro de fuente de venta -->
    <div class="col-md-3">
        <div class="form-group">
            <label for="sell_list_filter_source">@lang('lang_v1.sources'):</label>
            <select name="sell_list_filter_source" class="form-control select2" style="width:100%">
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                name: 'tos.name',
                visible: <?php echo empty($is_types_service_enabled) ? 'false' : 'true'; ?>
            },
            {
            ...
            },
            {
                data: 'table_name',
                name: 'tables.name',
                visible: <?php echo empty($is_tables_enabled) ? 'false' : 'true'; ?>
            },
            {
                data: 'waiter',
                name: 'ss.first_name',
                visible: <?php echo empty($is_service_staff_enabled) ? 'false' : 'true'; ?>
            },
        ],
        ...
        "footerCallback": function(row, data, start, end, display) {
            ...
            for (var r in data) {
                footer_sale_total += $(data[r].final_total).data('orig-value') ? parseFloat($(data[r]
                    .final_total).data('orig-value')) : 0;
