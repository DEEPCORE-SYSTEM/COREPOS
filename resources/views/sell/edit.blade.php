...
@section('content')
    ...
    <section class="content">
        ...
        <form action="{{ action('SellPosController@update', ['id' => $transaction->id]) }}" method="POST"
            id="edit_sell_form" enctype="multipart/form-data">
            @method('PUT')

            <input type="hidden" name="location_id" value="{{ $transaction->location_id }}" id="location_id"
                    ...
                    @component('components.widget', ['class' => 'box-solid'])
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        </span><input type="hidden" name="price_group"
                                            value="{{ $transaction->selling_price_group_id }}" id="price_group">
                                        <input type="text" name="price_group_text"
                                            value="{{ $transaction->price_group->name }}" class="form-control" readonly>
                                        <span class="input-group-addon">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="types_of_service_text"
                                            value="{{ $transaction->types_of_service->name }}" class="form-control" readonly>
                                        <input type="hidden" name="types_of_service_id"
                                            value="{{ $transaction->types_of_service_id }}" id="types_of_service_id">
                                        <span class="input-group-addon">
                        ...
                        @if (in_array('subscription', $enabled_modules))
                            <div class="col-md-4 pull-right col-sm-6">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_recurring" value="1" class="input-icheck"
                                            id="is_recurring" @if ($transaction->is_recurring) checked @endif>
                        ...
                        <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="contact_id" class="form-control mousetrap" id="customer_id"
                                        placeholder="Enter Customer name / phone" required>
                                        <!-- Aquí puede ir alguna opción predeterminada si es necesario -->
                                    </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="multi-input">
                                    ...
                                    <br />
                                    <input type="number" name="pay_term_number" value="{{ $transaction->pay_term_number }}"
                                    ...
                                    <select name="pay_term_type" class="form-control width-60 pull-left"
                                        ...
                                        <option value="months" @if ($transaction->pay_term_type == 'months') selected @endif>
                                            @lang('lang_v1.months')</option>
                                        <option value="days" @if ($transaction->pay_term_type == 'days') selected @endif>
                                            @lang('lang_v1.days')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="commission_agent" class="form-control select2">
                                        @foreach ($commission_agent as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $transaction->commission_agent) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="transaction_date"
                                        value="{{ $transaction->transaction_date }}" class="form-control" readonly required>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control select2" required>
                                        ...
                                        @foreach ($statuses as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $status) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="invoice_scheme_id" class="form-control select2">
                                        ...
                                        @foreach ($invoice_schemes as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $default_invoice_schemes->id) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        @can('edit_invoice_number')
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label
                                        for="invoice_no">{{ $transaction->type == 'sales_order' ? __('restaurant.order_no') : __('sale.invoice_no') }}:</label>
                                    <input type="text" name="invoice_no" value="{{ $transaction->invoice_no }}"
                                        class="form-control"
                        ...
                        @if (!empty($custom_field_1_label))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="custom_field_1" value="{{ $transaction->custom_field_1 }}"
                        ...
                        @if (!empty($custom_field_2_label))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="custom_field_2" value="{{ $transaction->custom_field_2 }}"
                        ...
                        @if (!empty($custom_field_3_label))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="custom_field_3" value="{{ $transaction->custom_field_3 }}"
                        ...
                        @if (!empty($custom_field_4_label))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="custom_field_4" value="{{ $transaction->custom_field_4 }}"
                        ...
                        @if ((!empty($pos_settings['enable_sales_order']) && $transaction->type != 'sales_order') || $is_order_request_enabled)
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select name="sales_order_ids[]" id="sales_order_ids"
                                        class="form-control select2 not_loaded" multiple>
                                        @foreach ($sales_orders as $id => $order)
                                            <option value="{{ $id }}"
                                                @if (in_array($id, $transaction->sales_order_ids ?? [])) selected @endif>
                                                {{ $order }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    @component('components.widget', ['class' => 'box-solid'])
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="rp_redeemed_modal" id="rp_redeemed_modal"
                                            class="form-control direct_sell_rp_input" value="{{ $transaction->rp_redeemed }}"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tax_rate_id" id="tax_rate_id" class="form-control"
                                            ...
                                            @foreach ($taxes['tax_rates'] as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $transaction->tax_id == $key ? 'selected' : '' }}
                                                    @foreach ($taxes['attributes'][$key] ?? [] as $attr_key => $attr_value)
												{{ $attr_key }}="{{ $attr_value }}" @endforeach>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="sale_note" id="sell_note" class="form-control" rows="3">{{ old('sale_note', $transaction->additional_notes) }}</textarea>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea name="shipping_details" id="shipping_details" class="form-control"
                                    placeholder="{{ __('sale.shipping_details') }}" rows="3" cols="30">{{ old('shipping_details', $transaction->shipping_details) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea name="shipping_address" id="shipping_address" class="form-control"
                                    placeholder="{{ __('lang_v1.shipping_address') }}" rows="3" cols="30">{{ old('shipping_address', $transaction->shipping_address) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="shipping_charges" id="shipping_charges"
                                        ...
                                        value="{{ old('shipping_charges', @num_format($transaction->shipping_charges)) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="shipping_status" id="shipping_status" class="form-control">
                                    ...
                                    @foreach ($shipping_statuses as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ $key == old('shipping_status', $transaction->shipping_status) ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="delivered_to" id="delivered_to" class="form-control"
                                    ...
                                    value="{{ old('delivered_to', $transaction->delivered_to) }}">
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_custom_field_1" id="shipping_custom_field_1"
                                            ...
                                            value="{{ old('shipping_custom_field_1', $transaction->shipping_custom_field_1) }}"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_custom_field_2" id="shipping_custom_field_2"
                                            ...
                                            value="{{ old('shipping_custom_field_2', $transaction->shipping_custom_field_2) }}"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_custom_field_3" id="shipping_custom_field_3"
                                            ...
                                            value="{{ old('shipping_custom_field_3', $transaction->shipping_custom_field_3) }}"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_custom_field_4" id="shipping_custom_field_4"
                                            ...
                                            value="{{ old('shipping_custom_field_4', $transaction->shipping_custom_field_4) }}"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_custom_field_5" id="shipping_custom_field_5"
                                            ...
                                            value="{{ old('shipping_custom_field_5', $transaction->shipping_custom_field_5) }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="shipping_documents[]" id="shipping_documents"
                                ...
                                <div class="col-md-4 export_div"
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                name="export_custom_fields_info[export_custom_field_{{ $i }}]"
                                                id="export_custom_field_{{ $i }}" class="form-control"
                                                placeholder="{{ __('lang_v1.export_custom_field' . $i) }}"
                                                value="{{ !empty($transaction->export_custom_fields_info['export_custom_field_' . $i]) ? $transaction->export_custom_fields_info['export_custom_field_' . $i] : '' }}">
                                        </div>
                                    </div>
                                </div>
                            @endfor
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="prefer_payment_method" id="prefer_payment_method" class="form-control"
                                            style="width: 100%;">
                                            @foreach ($payment_types as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $transaction->prefer_payment_method == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="prefer_payment_account" id="prefer_payment_account" class="form-control"
                                            ...
                                            @foreach ($accounts as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $transaction->prefer_payment_account == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                ...
                @can('sell.payments')
                    @component('components.widget', ['class' => 'box-solid', 'title' => __('purchase.add_payment')])
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="hidden" name="change_return" value="{{ $change_return['amount'] }}"
                                class="form-control change_return input_number" required id="change_return">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <input type="hidden" name="is_save_and_print" value="0" id="is_save_and_print">
