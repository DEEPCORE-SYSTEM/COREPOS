                            ...
                            <table class="table table-bordered table-striped table-condensed" id="stock_adjustment_product_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sm-2 text-center">@lang('sale.subtotal')</th>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="total_amount_recovered" id="total_amount_recovered" class="form-control input_number" value="0" placeholder="{{ __('stock_adjustment.total_amount_recovered') }}">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="additional_notes">{{ __('stock_adjustment.reason_for_stock_adjustment') }}:</label>
                            <textarea name="additional_notes" id="additional_notes" class="form-control" rows="3" placeholder="{{ __('stock_adjustment.reason_for_stock_adjustment') }}"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
