<tr class="product_row">
    ...
    @endphp
    <!-- Columna para la selección del impuesto -->
    <td class="{{$hide_tax}}">
        ...
        <select name="products[{{$row_count}}][tax_id]" class="form-control tax_id">
            ...
            <option value="{{ $key }}" {{ $tax_id == $key ? 'selected' : '' }}>{{ $value }}</option>
            @endforeach
        </select>
    </td>

    <!-- Columna para el precio unitario con impuesto incluido -->
    <td class="{{$hide_tax}}">
    ...
    <!-- Columna para el total de la línea de producto -->
    <td>
    ...
    <!-- Campo para el número de lote, si está habilitado en la configuración de negocio -->
    @if(session('business.enable_lot_number'))
    <td>
        <input type="text" name="products[{{$row_count}}][lot_number]" class="form-control input-sm">
    </td>
    @endif

    <!-- Campo para la fecha de expiración, si está habilitado en la configuración de negocio -->
    ...
    <td style="text-align: left;">
        <div class="input-group">
            ...
            <input type="text" name="products[{{$row_count}}][exp_date]" class="form-control input-sm expiry_datepicker"
                readonly>
        </div>
    </td>
    @endif
