...
@section('content')
    ...
    <section class="content no-print">
        ...
        <input type="hidden" name="location_id" id="location_id" value="{{ $sell->location->id }}"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="invoice_no" id="invoice_no"
                                    value="{{ !empty($sell->return_parent->invoice_no) ? $sell->return_parent->invoice_no : '' }}"
                                    class="form-control">
...
value="{{ format_datetime($transaction_date) }}" 
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="discount_amount" id="discount_amount"
                                    value="{{ @num_format($discount_amount) }}" class="form-control input_number">
                            </div>
                        </div>
                    </div>
                    @php
