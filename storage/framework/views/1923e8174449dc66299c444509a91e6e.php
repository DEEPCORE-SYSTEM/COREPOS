...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form action="<?php echo e(action('ImportProductsController@store'), false); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label for="products_csv"><?php echo e(__('product.file_to_import'), false); ?>:</label>
                                <input type="file" name="products_csv" id="products_csv" accept=".xls, .xlsx, .csv"
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td>9</td>
                    <td><?php echo app('translator')->get('product.alert_quantity'); ?> <small class="text-muted">(<?php echo app('translator')->get('lang_v1.optional'); ?>)</small>
                    </td>
                ...
                <tr>
                    ...
                    <td><?php echo app('translator')->get('product.product_type'); ?> <br>
                        <strong><?php echo app('translator')->get('lang_v1.available_options'); ?>: single, variable</strong>
                    </td>
                </tr>
                <tr>
                    <td>15</td>
                ...
                <tr>
                    <td>24</td>
                    <td><?php echo app('translator')->get('lang_v1.enable_imei_or_sr_no'); ?> <small class="text-muted">(<?php echo app('translator')->get('lang_v1.optional'); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\corepos\resources\views/import_products/index.blade.php ENDPATH**/ ?>