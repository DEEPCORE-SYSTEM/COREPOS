...
<?php if(!empty($api_key)): ?>
    <?php $__env->startSection('css'); ?>
        <?php echo $__env->make('contact.partials.google_map_styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label>
                        ...
                        <strong><?php echo app('translator')->get('lang_v1.sell_return'); ?></strong>
                    </label>
                </div>
            </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>
                            ...
                            <strong><?php echo app('translator')->get('report.purchase_due'); ?></strong>
                        </label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>
                            ...
                            <strong><?php echo app('translator')->get('lang_v1.purchase_return'); ?></strong>
                        </label>
                    </div>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\corepos\resources\views/contact/index.blade.php ENDPATH**/ ?>