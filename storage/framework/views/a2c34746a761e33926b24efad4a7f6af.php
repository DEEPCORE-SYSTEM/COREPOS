...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form action="<?php echo e(action('ContactController@postImportContacts'), false); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?> <!-- Token de seguridad para formularios POST en Laravel -->
        ...
        <div class="col-sm-6">
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <label for="contacts_csv"><?php echo app('translator')->get('product.file_to_import'); ?>:</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\corepos\resources\views/contact/import.blade.php ENDPATH**/ ?>