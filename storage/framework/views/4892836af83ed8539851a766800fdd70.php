        ...
        <div class="row">
            ...
            <div class="col-md-12 form_col" style="display: none;">
                ...
                <?php $__env->startComponent('components.widget'); ?>
                    ...
                    <form action="<?php echo e(action('\\App\\Http\\Controllers\\Install\\ModulesController@uploadModule'), false); ?>"
                        method="POST" id="upload_module_form" enctype="multipart/form-data" style="display:none">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <label for="module"><?php echo e(__('lang_v1.upload_module'), false); ?>:*</label>
                                    ...
                                    <!-- Mensaje de ayuda -->
                                    <p class="help-block">
                                        <?php echo e(__('lang_v1.pls_upload_valid_zip_file'), false); ?>
                            ...
                            <div class="col-sm-4">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm">
                                    <?php echo e(__('lang_v1.upload'), false); ?>
                                ...
                                <button type="button" class="btn btn-danger btn-sm cancel_upload_btn">
                                    <?php echo e(__('messages.cancel'), false); ?>
                    ...
                    <table class="table">
                        ...
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                disabled
                            <?php else: ?>
                                href="<?php echo e($module['install_link'], false); ?>" <?php endif; ?>>
                                    ...
                                    title="<?php echo app('translator')->get('lang_v1.disabled_in_demo'); ?>"
                                <?php else: ?>
                                    href="<?php echo e($module['uninstall_link'], false); ?>" <?php endif; ?>
                                            onclick="return confirm('Do you really want to uninstall the module? Module will be uninstall but the data will not be deleted')"><?php echo app('translator')->get('lang_v1.uninstall'); ?>
                                        </a>
                                    ...
                                    <form
                                    action="<?php echo e(action('Install\ModulesController@destroy', ['manage_module' => $module['name']]), false); ?>"
                                    ...
                                    <button class="btn btn-danger btn-xs"
                                        <?php if($is_demo): ?> disabled="disabled" title="<?php echo app('translator')->get('lang_v1.disabled_in_demo'); ?>" <?php endif; ?>>
                                ...
                                <td>
                                    ...
                                    <?php if(isset($module['version'])): ?>
                                        <small class="label bg-gray"><?php echo app('translator')->get('lang_v1.version'); ?>
                                            <?php echo e($module['version']['installed_version'], false); ?></small>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\corepos\resources\views/install/modules/index.blade.php ENDPATH**/ ?>