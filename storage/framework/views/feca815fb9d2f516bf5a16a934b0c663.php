...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="type" id="product_list_filter_type" class="form-control select2" style="width:100%">
                        ...
                        <option value="single"><?php echo e(__('lang_v1.single'), false); ?></option>
                        <option value="variable"><?php echo e(__('lang_v1.variable'), false); ?></option>
                        <option value="combo"><?php echo e(__('lang_v1.combo'), false); ?></option>
                    </select>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="unit_id" id="product_list_filter_unit_id" class="form-control select2"
                        ...
                        <option value="<?php echo e($key, false); ?>"><?php echo e($unit, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="product_list_filter_tax_id"><?php echo e(__('product.tax'), false); ?>:</label>
                    <select name="tax_id" id="product_list_filter_tax_id" class="form-control select2"
                        ...
                        <option value="<?php echo e($key, false); ?>"><?php echo e($tax, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="product_list_filter_brand_id"><?php echo e(__('product.brand'), false); ?>:</label>
                    <select name="brand_id" id="product_list_filter_brand_id" class="form-control select2"
                        ...
                        <option value="<?php echo e($key, false); ?>"><?php echo e($brand, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3" id="location_filter">
                <div class="form-group">
                    <label for="location_id"><?php echo e(__('purchase.business_location'), false); ?>:</label>
                    <select name="location_id" id="location_id" class="form-control select2" style="width:100%">
                        <option value=""><?php echo e(__('lang_v1.all'), false); ?></option>
                        <?php $__currentLoopData = $business_locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key, false); ?>"><?php echo e($location, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <br>
                    <label for="not_for_selling">
                        <input type="checkbox" name="not_for_selling" id="not_for_selling" value="1"
                            class="input-icheck">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <br>
                    <label for="woocommerce_enabled">
                        <input type="checkbox" name="woocommerce_enabled" id="woocommerce_enabled" value="1"
                            class="input-icheck">
                        <?php echo e(__('lang_v1.woocommerce_enabled'), false); ?>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        ...
                        <br><br>
                        <?php endif; ?>
                        <?php echo $__env->make('product.partials.product_list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stock_report.view')): ?>
                    <div class="tab-pane" id="product_stock_report">
                        <?php echo $__env->make('report.partials.stock_report_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <?php if($is_woocommerce): ?>
    <?php echo $__env->make('product.partials.toggle_woocommerce_sync_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
    <?php echo $__env->make('product.partials.edit_product_location_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
