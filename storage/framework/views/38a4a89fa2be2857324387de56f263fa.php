...
<html lang="<?php echo e(config('app.locale'), false); ?>">
    ...
    <body>
        <?php echo $__env->make('layouts.partials.home_header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <div class="container">
            <div class="content">
...
</html><?php /**PATH C:\xampp\htdocs\corepos\resources\views/layouts/home.blade.php ENDPATH**/ ?>