...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <a href="<?php echo e(action('SellingPriceGroupController@export'), false); ?>"
                class="btn btn-primary"><?php echo app('translator')->get('lang_v1.export_selling_price_group_prices'); ?></a>
        </div>
        <div class="col-sm-6">
            <!-- Formulario para importar precios del grupo de venta -->
            <form action="<?php echo e(route('selling_price_group.import'), false); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
