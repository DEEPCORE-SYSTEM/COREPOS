...
<div class="modal-dialog modal-lg" role="document">
    <form action="{{ action('\Modules\Project\Http\Controllers\TaskController@store') }}" 
          method="POST" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    {{ __('project::lang.create_task') }}  <!-- Título del modal -->
                </h4>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="due_date" id="due_date" class="form-control datepicker" readonly>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btn-sm ladda-button" data-style="expand-right">
                    <span class="ladda-label">{{ __('messages.save') }}</span>
                </button>
