<div class="modal-dialog" role="document">
    <div class="modal-content">
        <!-- Formulario para agregar un nuevo modelo de dispositivo -->
        <form action="{{ url('repair/device-model/store') }}" method="POST" id="device_model">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="repair_checklist" id="repair_checklist" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <!-- Botón para guardar el modelo de dispositivo -->
