...
class JobSheet extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\User::class, 'service_staff');
    }
    ...
    {
        return $this->belongsTo(\App\Models\Category::class, 'device_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Transaction::class, 'repair_job_sheet_id');
    }
