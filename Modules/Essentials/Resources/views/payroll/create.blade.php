...
<section class="content">
    ...
    <form action="{{ action('\Modules\Essentials\Http\Controllers\PayrollController@store') }}" 
        ...
        <div class="row">
                ...
                @component('components.widget')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="essentials_duration_unit" id="essentials_duration_unit" class="form-control" 
                                   placeholder="@lang('essentials::lang.duration_unit')" value="Hour">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="essentials_amount_per_unit_duration" id="essentials_amount_per_unit_duration" 
                                   class="form-control input_number" required placeholder="@lang('essentials::lang.amount_per_unit_duartion')" value="0">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="total" id="total" class="form-control input_number" placeholder="@lang('sale.total')" value="0">
                        </div>
                    </div>
                @endcomponent
            </div>
                            ...
                            @if(!empty($allowances))
                                @foreach($allowances['allowance_names'] as $key => $value)
                                    @include('essentials::payroll.allowance_and_deduction_row', [
                                        ...
                                        'amount_type' => $allowances['allowance_types'][$key],
                                        'percent' => $allowances['allowance_percents'][$key]
                                    ])
                                    @php $total_allowances += $allowances['allowance_amounts'][$key]; @endphp
                                @endforeach
                            @else
                            ...
                            @if(!empty($deductions))
                                @foreach($deductions['deduction_names'] as $key => $value)
                                    @include('essentials::payroll.allowance_and_deduction_row', [
                                        ...
                                        'amount_type' => $deductions['deduction_types'][$key],
                                        'percent' => $deductions['deduction_percents'][$key]
                                    ])
                                    @php $total_deductions += $deductions['deduction_amounts'][$key]; @endphp
                                @endforeach
                            @else
            ...
            <div class="col-md-12">
                ...
                <br>
                <input type="hidden" name="final_total" id="gross_amount" value="0">
            </div>
        </div>
