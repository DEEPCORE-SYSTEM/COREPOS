        ...
        <form action="{{ action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@updateSubscription') }}" method="POST" id="edit_subscription_form">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="start_date">@lang("superadmin::lang.start_date")</label>
                ...
                <div class="form-group">
                    <label for="end_date">@lang("superadmin::lang.end_date")</label>
                ...
                <div class="form-group">
                    <label for="trial_end_date">@lang("superadmin::lang.trial_end_date")</label>
